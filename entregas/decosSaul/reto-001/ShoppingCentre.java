    ...
    public static void main(String[] args) {
        ...
        do{
                ...
                if (modifiedRegister != -1){
                    registerStatus[modifiedRegister] += 1;
                }
                ...
                for (int checking = 0; checking < register.length; checking ++){
                    if (registerStatus[checking] % 2 == 0){
            ...
            System.out.println("CashRegister1:[" + register[0] + "] | CashRegister2:[" + register[1] + "] | CashRegister3:[" + register[2] + "] | CashRegister4:[" + register[3] + "]");
            System.out.println();
